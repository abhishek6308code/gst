...
export function Course({ onNavigate }: CourseProps) {
    const services = [
        ...
        {
            icon: Calculator,
            title: 'Advanced GST & Practical Training',
        ...
        {
            icon: TrendingUp,
            title: 'Career & Freelancing in GST',
...
{ value: '5000+', label: 'Returns Practiced' },
{ value: '99%', label: 'Practical Accuracy' },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
                ...
                <span className="text-blue-600"> Financial Learning</span>
              </h1>
              <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed">
                Simplify your financial Learning with expert  Teachers GST filing, bookkeeping, and tax advisory services tailored for small businesses and freelancers across India.
              </p>
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
                <div className="space-y-6">
                  <div className="flex items-center space-x-4 p-4 bg-green-50 rounded-lg">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">100% JOB Ready</p>
